...
# Make sure to replace OWNER, AGENT, USER with your wallets (with some junox tokens on a balance)
...
# proxy_call
sleep 10      # is needed to make sure this call is the next block 
