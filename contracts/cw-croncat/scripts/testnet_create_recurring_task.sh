...
RECURRING='{"create_task":{"task":{"interval":{"Block":15},"boundary":{"start":null,"end":null},"stop_on_fail":false,"actions":[{"bank":{"send":{"amount":[{"amount":"1","denom":"ujunox"}],"to_address":"juno1yhqft6d2msmzpugdjtawsgdlwvgq3samrm5wrw"}}},{"bank":{"send":{"amount":[{"amount":"1","denom":"ujunox"}],"to_address":"juno15w7hw4klzl9j2hk4vq7r3vuhz53h3mlzug9q6s"}}}],"rules":[]}}}'
